...
const ContentBangalo = (props) => {
    const data=props.data;
    console.log(data.name)
    return (
        <div className="content">
            <h1>{data.name}</h1>
            <h2>starting from {data.pricePerNight} / day</h2>
            <h2>Camping location for {data.space} people</h2>
            ...
            <div className="sub-grid">
                ...
                <div className="sub-content">
                    <div className="contact-bangalo">
                        ...
                        <a className='watsap' href={`https://wa.me/${data.phone}`} target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={faWhatsapp} /> WhatsApp</a>
